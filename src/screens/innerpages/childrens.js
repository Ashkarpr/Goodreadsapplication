              ...
              <View style={{...style.shadow,alignItems:"center",height:40,flexDirection:"row",backgroundColor:"white",width:"100%",borderWidth:1.5,borderColor:"lightgray",borderRadius:3}}>
               ...
               <View style={{marginTop:"2%",width:"100%"}}>
                    ...
                    <View style={{flexDirection:"row",justifyContent:"center",alignItems:"center",marginTop:"10%",width:"100%"}}> 
                       <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        ...
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/k4.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/k3.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                    </View>
               ...
               <View style={{marginTop:"2%",width:"100%"}}>
                ...
                <View style={{flexDirection:"row",justifyContent:"center",alignItems:"center",marginTop:"5%",width:"100%"}}> 
                       <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/k2.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/k1.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
               ...
               <View style={{marginTop:"2%",width:"100%"}}>
                ...
                <View style={{flexDirection:"row",justifyContent:"center",alignItems:"center",marginTop:"5%",width:"100%"}}> 
                       <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/tree.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/lp.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
               ...
               <View style={{marginTop:"2%",width:"100%"}}>
                ...
                <View style={{marginTop:"5%"}}>
                    <Text>
                        "Make it a rule to give a child a book you would not
               ...
               <View style={{marginTop:"2%",width:"100%"}}>
                ...
                <View style={{width:"100%",alignItems:"center",justifyContent:"center",marginTop:"5%"}}>
                    <TouchableOpacity>
                        <Image source={require("../../assets/bl.jpg")} style={{height:140,width:370}} />
                    </TouchableOpacity>
