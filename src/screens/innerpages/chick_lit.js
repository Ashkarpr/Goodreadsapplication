              ...
              <View style={{...style.shadow,alignItems:"center",height:40,flexDirection:"row",backgroundColor:"white",width:"100%",borderWidth:1.5,borderColor:"lightgray",borderRadius:3}}>
               ...
               <View style={{marginTop:"2%",width:"100%"}}>
                    ...
                    <View style={{flexDirection:"row",justifyContent:"center",alignItems:"center",marginTop:"10%",width:"100%"}}> 
                       <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/lay.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/wist.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
               ...
               <View style={{marginTop:"2%",width:"100%"}}>
                ...
                <View style={{flexDirection:"row",justifyContent:"center",alignItems:"center",marginTop:"5%",width:"100%"}}> 
                       <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/powerofhabit.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/ch.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/gq.png")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                    </View>
                    <View style={{flexDirection:"row"}}>
               ...
               <View style={{marginTop:"2%",width:"100%"}}>
                ...
                <View style={{width:"100%",alignItems:"center",justifyContent:"center",marginTop:"5%"}}>
                    <TouchableOpacity>
                        <Image source={require("../../assets/chil.png")} style={{height:140,width:370}} />
                    </TouchableOpacity>
