              ...
              <View style={{...style.shadow,alignItems:"center",height:40,flexDirection:"row",backgroundColor:"white",width:"100%",borderWidth:1.5,borderColor:"lightgray",borderRadius:3}}>
               ...
               <View style={{marginTop:"2%",width:"100%"}}>
                    ...
                    <View style={{flexDirection:"row",justifyContent:"center",alignItems:"center",marginTop:"10%",width:"100%"}}> 
                       <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/co1.jpeg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/co2.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/co71.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                    </View>
               ...
               <View style={{marginTop:"2%",width:"100%"}}>
                ...
                <View style={{flexDirection:"row",justifyContent:"center",alignItems:"center",marginTop:"5%",width:"100%"}}> 
                       <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/co04.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/co05.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/co06.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                    </View>
                    <View style={{flexDirection:"row"}}>
               ...
               <View style={{marginTop:"2%",width:"100%"}}>
                ...
                <View style={{flexDirection:"row",justifyContent:"center",alignItems:"center",marginTop:"5%",width:"100%"}}> 
                       <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        ...
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/co08.jpeg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                        <View style={{padding:"4%",justifyContent:"center",alignItems:"center"}}>
                        <TouchableOpacity >
                            <Image source={require("../../assets/co09.jpg")} style={{height:150,width:100,resizeMode:"contain"}} />
                        </TouchableOpacity>
                        </View>
                    </View>
                    <View style={{flexDirection:"row"}}>
               ...
               <View style={{marginTop:"2%",width:"100%"}}>
                ...
                <View style={{width:"100%",alignItems:"center",justifyContent:"center",marginTop:"5%"}}>
                    <TouchableOpacity>
                        <Image source={require("../../assets/co010.jpg")} style={{height:140,width:370}} />
                    </TouchableOpacity>
