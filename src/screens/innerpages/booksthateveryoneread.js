  ...
  return(
    ...
    <View style={{flex:1,backgroundColor:"white",alignItems:"center",width:"100%"}}>
        ...
        <View style={{padding:"3%",borderBottomWidth:.5,borderTopWidth:8,borderTopColor:"lightgray",backgroundColor:"white",justifyContent:"center",width:"100%",alignItems:"center"}}>
          ...
          Books That Everyone Should Read At{"\n"}
          Least Once
          </Text>
         </View>
         ...
         <View style={{padding:"3%",width:"100%",backgroundColor:"white",flex:1}}>
             <TouchableOpacity>
                <Image  source={require("../../assets/1984.jpg")} style={{resizeMode:"contain"}} height={140} width={100}  />
            </TouchableOpacity>
        ...
        <View style={{padding:"3%",width:"100%",backgroundColor:"white",flex:1}}>
            <TouchableOpacity>
                <Image  source={require("../../assets/h1.jpg")} style={{resizeMode:"contain"}} height={140} width={100}  />
            </TouchableOpacity>
                <View style={{paddingTop:"5%",position:"absolute",left:"35%",backgroundColor:"white",width:"100%",}}>
                    <View style={{flexDirection:"row",}}>
         ...
         <Divider style={{height:1,alignSelf:"center",width:"110%",marginTop:"3%"}} />
          ...
          <View style={{padding:"3%",width:"100%",backgroundColor:"white",flex:1}}>
              <TouchableOpacity>
                 <Image  source={require("../../assets/hitch.jpg")} style={{resizeMode:"contain"}} height={140} width={100}  />
             </TouchableOpacity>
                <View style={{paddingTop:"5%",position:"absolute",left:"35%",backgroundColor:"white",width:"100%",}}>
                    <View style={{flexDirection:"row",}}>
         ...
         <View style={{padding:"3%",width:"100%",backgroundColor:"white",flex:1}}>
            <TouchableOpacity>
                <  Image  source={require("../../assets/lp.jpg")} style={{resizeMode:"contain"}} height={140} width={100}  />
            </TouchableOpacity>
                <View style={{paddingTop:"5%",position:"absolute",left:"35%",backgroundColor:"white",width:"100%",}}>
                    <View style={{flexDirection:"row",}}>
